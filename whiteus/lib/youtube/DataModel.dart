...
class VideoItems{
  ...
  factory VideoItems.fromJson(Map<String, dynamic> json) => _$VideoItemsFromJson(json);
...
class VideoSnippet{
  ...
  factory VideoSnippet.fromJson(Map<String, dynamic> json) => _$VideoSnippetFromJson(json);
...
class VideoStatistics{
  ...
  factory VideoStatistics.fromJson(Map<String, dynamic> json) => _$VideoStatisticsFromJson(json);
